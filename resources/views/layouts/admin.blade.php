        ...
        <div class="col-12 mt-5">
            <div class="card">
                ...
                <div class="card-header row m-0">
                    <div class="col-5 col-sm-5 col-md-4 col-lg-3 text-right "><a href="/admin"><img src="{{asset('assets/images/logo.png')}}" class="img-fluid" /></a></div>
                    <div class="col-2 col-sm-2 col-md-4 col-lg-6"></div>
                    <div class="row col-5 col-sm-5 col-md-4 col-lg-3 m-0 text-left ">
                        <div class="col-12"></div>
                        <div class="col-12"><a href="/home" class="btn btn-danger">لوحة الجوابات</a></div>
                    </div>
                </div>
                <div class="card-body">
                    @yield('content')
